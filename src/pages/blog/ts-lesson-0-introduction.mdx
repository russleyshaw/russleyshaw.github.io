...
The benefits to JavaScript are:
...
JavaScript is faster than you might expect. Google has invested large amounts of money into making JavaScript fast through the development of V8.
